CREATE TABLE IF NOT EXISTS `urls_%SITE_ID%` (
  `Site_Id` varchar(32) NOT NULL DEFAULT '',
  `URL` varchar(4096) NOT NULL DEFAULT '',
  `Type` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '0 - Regular, collect URLs and insert only for this site according filters; 1 - Single, do not collect URLs, 3 - collect URLs, create sites and insert for all, 4 - fetched by crawler as RSS feed item, 5 - realtime inserted, 6 - chain',
