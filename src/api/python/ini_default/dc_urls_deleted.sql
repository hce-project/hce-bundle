...
-- Database: `dc_sites`
--
CREATE DATABASE IF NOT EXISTS `dc_urls_deleted` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `urls_0` (
  ...
  `Type` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '0 - Regular, collect URLs and insert only for this site according filters; 1 - Single, do not collect URLs, 3 - collect URLs, create sites and insert for all, 4 - fetched by crawler as RSS feed item, 5 - realtime inserted, 6 - chain',
