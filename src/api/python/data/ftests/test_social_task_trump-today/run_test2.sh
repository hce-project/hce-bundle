...
cd /home/$USER/hce-node-bundle/api/python/bin && ./social_data_calculator.py -c=../ini/social_data_calculator_trump.ini --inputFile="$TINFILE" --outputFile="$TSOCFILE" --lang=ja --networks='tw,fb' --remote=1 --top=5
