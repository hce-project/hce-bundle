...
TEST_DIR=~/hce-node-bundle/api/python/data/ftests/test_dynamic_crawling\(dc-250\)
...
$HCE_BIN/drce.php --request=SET --host=localhost --port=5556 --n=1 --t=5000 --l=4 --json=$JSON
...
#NEW_SITE_FILES=$TEST_DIR/site_new_dynamic.json
