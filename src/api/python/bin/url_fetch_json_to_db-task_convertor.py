...
from app.UrlFetchJsonToDBTaskConvertor import UrlFetchToJsonDBTaskConvertor


# That script create main URLFetch request to the DBTask application
...
if __name__ == "__main__":
  try:
    # create the app
    app = UrlFetchToJsonDBTaskConvertor()
