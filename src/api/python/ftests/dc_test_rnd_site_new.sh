...
../manage/dc-client_start.sh "--command=SITE_DELETE --file=../data/ftests/dcc_site_delete_rnd.json" >> ../log/$0.log 2>&1

echo "Create new site" >> ../log/$0.log 2>&1
../manage/dc-client_start.sh "--command=SITE_NEW --file=../data/ftests/dcc_site_new_ok_rnd.json" >> ../log/$0.log 2>&1
